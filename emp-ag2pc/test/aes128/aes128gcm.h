...
*/
void InitialHashSubkey (unsigned char *ENC, const unsigned char *k);
void J0Definition (unsigned char *J0, const unsigned char *IV);
void IncrementingFunction(unsigned char *INC);
void GFMult128 (unsigned char *Z, const unsigned char *X, const unsigned char *YBLOCK);
...
void GHASH (unsigned char *OUT, const unsigned char *H, const unsigned char *X, const unsigned int len_total);
