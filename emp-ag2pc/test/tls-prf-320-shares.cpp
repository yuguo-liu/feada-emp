...
int main(int argc, char** argv) {
    ...
    if (party == ALICE) {
        alice_mask = generate_random_hex_string(80);
    } else {
        bob_mask = generate_random_hex_string(32) + "00000000000000000000000000000000" + generate_random_hex_string(8) + "00000000";
    }
    ...
    // );
    string ms_str = ag2pc_exec(party, io, circuit_file_location+"KDF/sha256_i_2_share_state_2_full_msg_o_2_share_hash_1_key_hash_320.txt",
