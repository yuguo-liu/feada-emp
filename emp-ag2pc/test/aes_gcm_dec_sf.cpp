...
//	io->set_nodelay();
    ...
    if (party == ALICE) {
        ...
        res = ag2pc_exec(party, io, circuit_file_location + "/AES/dec_ghash_1.txt", in);
        ...
        io_bob_ciphertext = msg_o.substr(0, 32);
        io_bob_tag = msg_o.substr(32, 32);
