...
int main(int argc, char** argv) {
    ...
    setup_plain_prot(true, "sha256_i_share_state_msg_o_hash.txt");

    Integer state_alice {256, 0, ALICE};
    Integer state_bob {256, 0, BOB};

    Integer hash_val {512, 0, BOB};

    Bit hash_val_res[256];
    Bit output_state[256];
    sha256_exec(hash_val, hash_val_res, (state_alice ^ state_bob), output_state);
